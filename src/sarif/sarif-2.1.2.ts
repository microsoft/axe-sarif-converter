...
export namespace Suppression {
    export type kind = 'inSource' | 'external';

    export type state = 'accepted' | 'underReview' | 'rejected';
}
...
export namespace ThreadFlowLocation {
    export type importance = 'important' | 'essential' | 'unimportant';
}
...
export namespace ToolComponent {
    export type contents = 'localizedData' | 'nonLocalizedData';
}
