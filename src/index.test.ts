...
describe('public convertAxeToSarif API', () => {
    ...
    it.each`
        ...
        ${'basic-axe-v4.11.3.reporter-v1.json'}        | ${'basic-axe-v4.11.3-v1.sarif'}
        ${'basic-axe-v4.11.3.reporter-v2.json'}        | ${'basic-axe-v4.11.3-v2.sarif'}
        ${'w3citylights-axe-v4.11.3.reporter-v1.json'} | ${'w3citylights-axe-v4.11.3-v1.sarif'}
        ${'w3citylights-axe-v4.11.3.reporter-v2.json'} | ${'w3citylights-axe-v4.11.3-v2.sarif'}
        ${'basic-axe-v4.12.1.reporter-v1.json'}        | ${'basic-axe-v4.12.1-v1.sarif'}
        ${'basic-axe-v4.12.1.reporter-v2.json'}        | ${'basic-axe-v4.12.1-v2.sarif'}
        ${'w3citylights-axe-v4.12.1.reporter-v1.json'} | ${'w3citylights-axe-v4.12.1-v1.sarif'}
        ${'w3citylights-axe-v4.12.1.reporter-v2.json'} | ${'w3citylights-axe-v4.12.1-v2.sarif'}
    `(
...
describe('public sarifReporter API', () => {
    ...
    it.each`
        inputFile                                | outputFile
        ${'basic-axe-v4.12.1.reporter-raw.json'} | ${'basic-axe-v4.12.1-v1.sarif'}
    `(
